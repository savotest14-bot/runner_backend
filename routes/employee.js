...
const { createEmployee, getAllEmployees, getEmployeeById, updateEmployee, toggleEmployeeDeleteByCompanyAdmin, getProfileForEmployee, updateEmployeeProfile, getEmployeeFinancial, getEmployeeDashboard, addComment, addReply, addExpense } = require("../controllers/employee");
...
router.put("/addExpense", authenticate, uploads.single("expenseImage"), addExpense)
